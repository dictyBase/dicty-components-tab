...
var Tabs = function (_Component) {
  ...
  function Tabs() {
    ...
    _this.handleScroll = function () {
      ...
      if (_this.tabBar.scrollLeft < 15 && scrollPos != "left") {
        _this.setState({
          scrollPos: "left"
        });
      } else if (_this.tabBar.scrollLeft > max - 15 && scrollPos != "right") {
        _this.setState({
          scrollPos: "right"
        });
      } else if (_this.tabBar.scrollLeft > 15 && _this.tabBar.scrollLeft < max - 15) {
        _this.setState({
          scrollPos: "middle"
        });
      }
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(LeftArrow, {
              visible: scrollPos != "left" && scrollPos != "none" ? true : false,
              pos: "left"
            }),
            this.renderTabs(),
            _react2.default.createElement(RightArrow, {
              visible: scrollPos != "right" && scrollPos != "none" ? true : false,
              pos: "right"
            })
          ),
          _react2.default.createElement(
